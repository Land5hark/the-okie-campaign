...
The Simpsons television cartoon

## Visual DNA

Yellow skin language, overbite profiles, round eyes, flat television-animation color.

## Medium and composition

Treat the master as two-dimensional animation key art in a simple supporting scene. Preserve a clear speech-bubble zone and readable OK hand sign.
