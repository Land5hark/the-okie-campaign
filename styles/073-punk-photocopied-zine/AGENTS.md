# Local agent direction: Punk photocopied zine

Read the root `AGENTS.md` and `character/CHARACTER-BIBLE.md` first.

## Objective

Translate canonical Okie into style 073 using this visual system:

> Torn photos, ransom typography, black toner noise, handwritten marks.
